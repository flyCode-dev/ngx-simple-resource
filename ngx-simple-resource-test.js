...
class HttpClientService {
     ...
     * @return {?}
     */
    parametrizeUrl(params, url) {
        const /** @type {?} */ urlParams = url.match(this.regex);
        for (let /** @type {?} */ i in urlParams) {
            const /** @type {?} */ urlParam = urlParams[i].replace(':', '');
    ...
    getQueryParams(params) {
        ...
        let /** @type {?} */ query = '?';
        for (let /** @type {?} */ i in params) {
            if (Array.isArray(params[i])) {
                query += undefined(params[i], param => `${i}=${param}&`).join('');
                continue;
            }
            query += `${i}=${params[i]}&`;
        }
    ...
    get(url, params = {}, additional = []) {
        const /** @type {?} */ headers = this.getHeaders(additional);
     ...
     * @return {?}
     */
    post(url, data, params = {}, additional = []) {
        const /** @type {?} */ headers = this.getHeaders(additional);
        url = this.parametrizeUrl(params, url);
        return this.http
     ...
     * @return {?}
     */
    put(url, data, params = {}, additional = []) {
        const /** @type {?} */ headers = this.getHeaders(additional);
        url = this.parametrizeUrl(params, url);
        return this.http
 ...
 * @nocollapse
 */
NgxResourceModule.ctorParameters = () => [];
...
//# sourceMappingURL=ngx-simple-resource-test.js.map

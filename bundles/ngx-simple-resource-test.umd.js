(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/router'), require('@angular/common/http'), require('rxjs/add/operator/catch'), require('rxjs/add/observable/throw'), require('rxjs/Observable')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common', '@angular/router', '@angular/common/http', 'rxjs/add/operator/catch', 'rxjs/add/observable/throw', 'rxjs/Observable'], factory) :
	(factory((global['ngx-simple-resource-test'] = {}),global.ng.core,global.ng.common,global.ng.router,global.ng.common.http,global.Rx.Observable.prototype,global.Rx.Observable,global.Rx));
}(this, (function (exports,core,common,router,http,_catch,_throw,Observable) { 'use strict';
...
var HttpClientService = (function () {
     ...
     * @param {?} router
     */
    function HttpClientService(http$$1, router$$1) {
        this.http = http$$1;
     ...
     * @return {?}
     */
    HttpClientService.prototype.getHeaders = function (additional) {
     ...
     * @return {?}
     */
    HttpClientService.prototype.parametrizeUrl = function (params, url) {
        var /** @type {?} */ urlParams = url.match(this.regex);
        for (var /** @type {?} */ i in urlParams) {
            var /** @type {?} */ urlParam = urlParams[i].replace(':', '');
     ...
     * @return {?}
     */
    HttpClientService.prototype.catcher = function () {
        var _this = this;
        return function (e) {
            if (e.status === 401) {
            ...
            if (e.status === 412) {
                _this.router.navigateByUrl('/banned-user');
            }
            if (e.error) {
                return Observable.Observable.throw(e.error);
            }
            else {
     ...
     * @return {?}
     */
    HttpClientService.prototype.getQueryParams = function (params) {
        if (!params) {
            return '';
        }
        var /** @type {?} */ query = '?';
        var _loop_1 = function (i) {
            if (Array.isArray(params[i])) {
                query += undefined(params[i], function (param) { return i + "=" + param + "&"; }).join('');
                return "continue";
            }
            query += i + "=" + params[i] + "&";
        };
        for (var /** @type {?} */ i in params) {
            _loop_1(/** @type {?} */ i);
        }
        // Removing last &
     ...
     * @return {?}
     */
    HttpClientService.prototype.get = function (url, params, additional) {
        if (params === void 0) { params = {}; }
        if (additional === void 0) { additional = []; }
        var /** @type {?} */ headers = this.getHeaders(additional);
     ...
     * @return {?}
     */
    HttpClientService.prototype.post = function (url, data, params, additional) {
        if (params === void 0) { params = {}; }
        if (additional === void 0) { additional = []; }
        var /** @type {?} */ headers = this.getHeaders(additional);
        url = this.parametrizeUrl(params, url);
     ...
     * @return {?}
     */
    HttpClientService.prototype.put = function (url, data, params, additional) {
        if (params === void 0) { params = {}; }
        if (additional === void 0) { additional = []; }
        var /** @type {?} */ headers = this.getHeaders(additional);
        url = this.parametrizeUrl(params, url);
     ...
     * @return {?}
     */
    HttpClientService.prototype.delete = function (url, params, additional) {
        if (params === void 0) { params = {}; }
        if (additional === void 0) { additional = []; }
        var /** @type {?} */ headers = this.getHeaders(additional);
        url = this.parametrizeUrl(params, url);
     ...
     * @return {?}
     */
    HttpClientService.prototype.setUserToken = function (token) {
     ...
     * @return {?}
     */
    HttpClientService.prototype.getUserToken = function () {
     ...
     * @return {?}
     */
    HttpClientService.prototype.query = function (params, queryParams) {
        if (params === void 0) { params = ''; }
     ...
     * @return {?}
     */
    HttpClientService.prototype.show = function (queryParams) {
        if (queryParams === void 0) { queryParams = {}; }
     ...
     * @return {?}
     */
    HttpClientService.prototype.create = function (data, queryParams) {
        if (queryParams === void 0) { queryParams = {}; }
     ...
     * @return {?}
     */
    HttpClientService.prototype.update = function (data, queryParams) {
        if (queryParams === void 0) { queryParams = {}; }
     ...
     * @return {?}
     */
    HttpClientService.prototype.remove = function (queryParams) {
        if (queryParams === void 0) { queryParams = {}; }
...
var NgxResourceModule = (function () {
    function NgxResourceModule() {
    }
    return NgxResourceModule;
}());
NgxResourceModule.decorators = [
 ...
 * @nocollapse
 */
NgxResourceModule.ctorParameters = function () { return []; };

exports.HttpClientService = HttpClientService;
exports.NgxResourceModule = NgxResourceModule;

Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=ngx-simple-resource-test.umd.js.map
